...
- Model selection based on `has_full_text`:
  - Abstract-only -> `pass1_model_abstract` (`gemini-3.6-flash`, MEDIUM thinking)
  - Full-text -> `pass1_model_fulltext` (`gemini-3.6-flash`, HIGH thinking)
